...
import {translateKey} from "../../i18n/translationUtils";
import {useTheme} from "@mui/material";
import NTCButton from "../base/NTCButton.jsx";
import BaseModalDialog from "../base/modals/BaseModalDialog.jsx";

import TranslationControls from "./TranslationControls.jsx"
import DisplayFormatSelector from "./DisplayFormatSelector.jsx";
...
export default function TranslationInput({ data, type, lists, rhf }) {
    ...
    const buttonColor = (translatedValue && translatedValue.length > 0) ? glacierBlue : nomadRed;
                    ...
                    <Box sx={{minWidth: '50vw', marginTop: '0em'}}>
                        <Stack direction={'row'} sx={{justifyContent: 'flex-end'}}>
                            <Box sx={{display: 'flex', justifyContent: 'flex-end', alignItems: 'center', marginTop: '0.5em'}}>
                                <div className="tertiary-button" style={{color: `${nomadRed}`}} onClick={handleCancel}>
                                    Cancel
                                </div>
                                <NTCButton text={'Save'} backgroundColor={nomadRed} onClick={handleSave}></NTCButton>
                            </Box>
                        </Stack>
                    </Box>
                </BaseModalDialog>
