...
//  ./webapps/default/
const DEFAULT = 'http://localhost:7000/default';
...
const INTERLOCKMAP = 'http://localhost:7000/interlock_mapper';
...
const CONFIGBUILDER = 'http://localhost:7000/config_builder';
...
let menuTemplate = [{
  label: "File",
  submenu: [{
    label: "Tip your local programmer",
    click: () => {
      switchWindow(INTERLOCKMAP, INTERLOCKMAP_PRELOAD);
    }
  }, {
    label: "Exit",
    click: () => {
  ...
  submenu: [{
    ...
    click: () => {
      switchWindow(MARKDOWN_DOCUMENTATION);
    }
  }]
}];
